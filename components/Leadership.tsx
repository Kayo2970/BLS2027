      ...
      <SectionWrapper>
        ...
        <div className="grid md:grid-cols-3 gap-8">
            {LEADERSHIP_MESSAGES.map((leader, idx) => (
                <BorderGlow key={idx} borderRadius={32} backgroundColor="#ffffff" glowColor="217 91% 60%" className="h-full">
                    <div className="group p-8 flex flex-col items-center text-center relative h-full">
